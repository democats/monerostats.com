---
title: Monero block | MoneroStats.com
description: 
keywords: 
layout: default
---
...
<div class="container">
   ...
   <div class="main-app-container" ng-if="block">
         <section class="blockchain">
            <div>
               <h1><span>Monero block </span><small>{{block.hash}}</small></h1>
        ...
        <table class="table dic">
         <tbody>
            ...
            <tr>
               ...
               <td>{{block.baseReward | asCoinUnits:selected_blockchain.coin_units}}</td>
            </tr>
            <tr>
               ...
               <td>{{block.totalFeeAmount | asCoinUnits:selected_blockchain.coin_units}}</td>
            </tr>
            <tr>
               <td>
                  <span>Reward</span>
               ...
               <td>{{block.reward | asCoinUnits:selected_blockchain.coin_units}}</td>
            </tr>
            <tr>
               <td>
               ...
               <td>{{block.alreadyGeneratedCoins | asCoinUnits:selected_blockchain.coin_units}}</td>
            </tr>
            <tr>
               <td>
      ...
      <table class="table transactions">
         <thead>
            <tr>
               <th>Hash</th>
               <th><span>Fee</span><span> (</span><span>{{selected_blockchain.ticker}}</span><span>)</span></th>
               <th><span>Total amount</span><span> (</span><span>{{selected_blockchain.ticker}}</span><span>)</span></th>
               <th>Size</th>
            </tr>
         </thead>
         <tbody>
            <tr ng-repeat="transaction in block.transactions">
               <td><a target="_self" href="/blockchain/transaction/?hash={{transaction.hash}}">{{transaction.hash}}</a></td>
               <td>{{transaction.fee | asCoinUnits:selected_blockchain.coin_units}}</td>
               <td>{{transaction.amount_out | asCoinUnits:selected_blockchain.coin_units}}</td>
   ...
   <div class="main-app-container" ng-if="!block">
      <section class="blockchain">
         <div>
            <h1><span>Monero block </span><small>{{hash}}</small><br />
